...
class Create extends Component
{
    ...
    public function save(): void
    {
        ...
        $validated = $this->validate([
            'codigo' => ['required', 'string', 'max:255', 'unique:radio_links,codigo'],
        ...
        RadioLink::create($validated);

        Flux::toast(variant: 'success', text: __('Radio link criado com sucesso.'));
    ...
    {
        return view('livewire.radio-links.create', [
