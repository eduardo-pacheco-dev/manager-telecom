...
class Configuracoes extends Component
{
    ...
    public function toggleAtivo(int $itemId): void
    {
        ...
        $this->dispatch('colaborador-configuracao-updated');
    }
    ...
    public function destroy(int $itemId): void
    {
        ...
        $this->dispatch('colaborador-configuracao-deleted');
    }
    ...
    private function modelo(): mixed
    {
        return match ($this->aba) {
            'cargos' => new ColaboradorCargo,
            'departamentos' => new ColaboradorDepartamento,
            default => new ColaboradorCategoria,
        };
    }

    public function render(): View
    {
        return view('livewire.colaboradores.configuracoes');
    }
}
