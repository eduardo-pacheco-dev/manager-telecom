<div class="flex h-full w-full flex-1 flex-col gap-4 rounded-xl p-4">
    <div class="relative mb-2 w-full">
        <flux:heading size="xl" level="1">{{ __('Nova Estação') }}</flux:heading>
        <flux:subheading size="lg" class="mb-6">{{ __('Preencha os dados para cadastrar uma nova estação') }}</flux:subheading>
