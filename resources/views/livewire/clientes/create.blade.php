<div class="flex h-full w-full flex-1 flex-col gap-6 p-4 sm:p-6">
    {{-- Page header --}}
    <x-ui.page-header
        :title="__('Novo Cliente')"
        :subtitle="__('Preencha os dados para cadastrar um novo cliente')"
        :breadcrumbs="[
                ...
                >
                    ...
                    <div class="grid gap-6 sm:grid-cols-2">
                        <flux:field>
                            ...
                            <flux:input wire:model="documento" type="text" placeholder="00.000.000/0000-00" maxlength="18" inputmode="numeric" required />
        ...
        <x-ui.form-nav :sections="[
            ...
            <div class="rounded-2xl border border-sky-200 bg-sky-50/60 p-4 dark:border-sky-400/20 dark:bg-sky-400/10">
                ...
                <p class="mt-1.5 text-xs leading-relaxed text-sky-800/80 dark:text-sky-200/70">
                    {{ __('Preencha pelo menos os campos obrigatórios. O CNPJ e o e-mail devem ser únicos no sistema.') }}
                </p>
            </div>
        </x-ui.form-nav>
    </div>
