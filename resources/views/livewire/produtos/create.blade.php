<div class="flex h-full w-full flex-1 flex-col gap-6 p-4 sm:p-6">
    {{-- Page header --}}
    <x-ui.page-header
        :title="__('Novo Produto')"
        :subtitle="__('Preencha os dados para cadastrar um novo produto')"
        :breadcrumbs="[
    ...
    >
        <flux:button href="{{ route('produtos.index') }}" wire:navigate variant="ghost" icon="arrow-left">
            {{ __('Voltar') }}
        </flux:button>
    </x-ui.page-header>
        ...
        <form wire:submit="save" class="w-full space-y-6">
            ...
            <div class="animate-fade-in-up flex flex-col gap-3 rounded-2xl border border-zinc-200 bg-white/90 p-4 backdrop-blur-md sm:flex-row sm:items-center sm:justify-between dark:border-white/10 dark:bg-zinc-900/90" style="animation-delay: 180ms">
                ...
                <div class="flex items-center gap-2">
                    <flux:button href="{{ route('produtos.index') }}" wire:navigate variant="filled">{{ __('Cancelar') }}</flux:button>
